...
if(SE_SECTION == 'frontend') {
    // default include en
    include SE_ROOT.'core/lang/en/dict-frontend.php';

    $language_file = SE_ROOT.'core/lang/'.$languagePack.'/dict-frontend.php';
	...
	include SE_ROOT.'core/lang/en/dict-backend.php';
	if($languagePack != 'en') {
