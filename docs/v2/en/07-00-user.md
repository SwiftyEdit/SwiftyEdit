...
The individual options can be found under <kbd>Users</kbd> <kbd>Edit user</kbd> in the
<kbd>Password</kbd> tab, where the rights checkboxes are managed alongside the password.
