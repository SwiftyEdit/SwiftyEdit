...
{alert:warning}
__Note:__ The `/install/` directory must not be deleted after setup - core functions (e.g. saving
...
{badge:info}Tip:{/badge} Under <kbd>Settings</kbd> → <kbd>General</kbd> → <kbd>System</kbd> you can set a login
