...
echo 'se_invoice.pay - preferences';
echo '</div>';

$pm_prefs_file = SE_CONTENT.'/modules/se_invoice.pay/pm_config.php';

if(isset($_POST['save_invoice_prefs'])) {

    $pm_prefs_content_file = file_get_contents(SE_CONTENT.'/modules/se_invoice.pay/pm_config.tpl');
...
echo '<form action="?tn=addons&sub=se_invoice.pay&a=preferences" method="POST">';
