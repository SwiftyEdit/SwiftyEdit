...
echo '<input type="submit" class="btn btn-primary w-100" name="select_group" value="'.$lang['edit'].'">';
echo '</div>';
echo '</div>';
echo '</form>';
echo '</fieldset>';
...
if(($editgroup) && ($show_data !== false)) {
	...
	$user_group = $db_user->get("se_groups","*",["group_id" => $editgroup]);
