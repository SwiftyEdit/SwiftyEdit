...
echo '<div class="subHeader">'.$icon['calendar_event'].' '.$lang['nav_events'].'</div>';
...
$input_event_time_offset = [
    ...
    "label" => $lang['label_event_time_offset'],
    "form_text" => $lang['event_time_offset_help_text']
];
...
$input_images_prefix = [
    ...
    "label" => $lang['label_images_prefix']
];
