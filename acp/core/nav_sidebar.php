...
echo '<ul>';
echo '<li><a class="sidebar-nav '.($sub == "mailbox" ? 'sidebar-nav-active' :'').'" href="acp.php?tn=inbox&sub=mailbox">'.$icon['envelope'].' '.$lang['nav_mailbox'].'<span class="nav-badge">Beta</span></a></li>';
