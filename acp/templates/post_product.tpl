	...
	<div class="row">
		<div class="col-md-9">
			...
			<ul class="nav nav-tabs card-header-tabs" id="bsTabs" role="tablist">
				...
				<li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#prices_delivery">{post_tab_prices_delivery}</a></li>
				<li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#options">{post_tab_options}</a></li>
				<li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#variants">{post_tab_variants}</a></li>
			...
			<div class="tab-content">
				<div class="tab-pane fade show active" id="intro">
					<div class="row">
						<div class="col-md-6">
							<label>{label_title}</label> <input class="form-control" name="title" type="text" value="{title}"> <label>{label_description}</label>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input class='form-control' name="product_number" type="text" value="{product_number}">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label>{label_product_manufacturer}</label>
								<input class='form-control' name="product_manufacturer" type="text" value="{product_manufacturer}">
							</div>
						</div>
						<div class="col-md-4">				
							<div class="form-group">
								<label>{label_product_supplier}</label>
								<input class='form-control' name="product_supplier" type="text" value="{product_supplier}">
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input class='form-control' name="product_currency" type="text" value="{product_currency}">
							</div>						
						</div>
						<div class="col-md-2">
							<div class="form-group">
								<label>{label_product_price_label}</label>
								<input class='form-control' name="product_price_label" type="text" value="{product_price_label}">
							</div>
						</div>
						<div class="col-md-8">
							<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class='form-control' name="file_attachment_external" type="text" value="{file_attachment_external}">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class='form-control' id="nbr_stock" name="product_nbr_stock" type="text" value="{product_nbr_stock}">
							</div>
							<div class="form-check">
								<input class="form-check-input" type="checkbox" name="product_ignore_stock" value="1" id="ignoreStock" {checkIgnoreStock}>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class='form-control' id="cnt_sales" name="product_cnt_sales" type="text" value="{product_cnt_sales}">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-2">
							<div class="form-group">
								...
								<input class='form-control' name="product_amount" type="text" value="{product_amount}">
							</div>
						</div>
						<div class="col-md-2">
							<div class="form-group">
								<label>{label_product_unit}</label>
								<input class='form-control' name="product_unit" type="text" value="{product_unit}">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="">
								...
								<input class='form-control' id="price" name="product_price_net" type="text" value="{product_price_net}">
							</div>
						</div>
						...
						<div class="col-md-2">
							...
							<div class="input-group">
								<input class='form-control' id="price_addition" name="product_price_addition" type="text" value="{product_price_addition}">
						...
						<div class="col-md-4">
							<div class="">
								...
								<input class='form-control' id="price_total" name="product_price_gross" type="text" value="{product_price_gross}">
							</div>
						</div>
					</div>
				...
				<div class="tab-pane fade" id="variants">
					<div class="form-group">
						...
						<input class='form-control' name="product_variant_title" type="text" value="{product_variant_title}">
					</div>
					<div class="form-group">
						<label>{label_description}</label>
						<textarea class='form-control' rows="4" name="product_variant_description">{product_variant_description}</textarea>
					</div>
					{variants_list}
				</div> <!-- #variants -->
